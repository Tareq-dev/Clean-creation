...
const HowWork = () => {
     return (
          ...
          <h2 className="text-center">How It Works</h2>
               <div class="row mt-5 work d-flex justify-content-center">
               <div class="col-md-3 col-12">
               <div class="d-flex justify-content-center">
               <img src="https://cleancreations.com/data/config/theme_howitworks_item1_image.svg?md=a90764e4d1943d70ade260f7af365720" alt="place-order" />
               </div>
               ...
               <img src="https://cleancreations.com/data/config/theme_howitworks_item2_image.svg?md=479cab042576f04da7f0a2ab489f63bb" alt="place-order" />
               </div>
               <div className="text-center">
               <h5>COOK</h5>
               ...
               <div className="col-md-3 col-12">
               <div className="d-flex justify-content-center">
               <img src="https://cleancreations.com/data/config/theme_howitworks_item3_image.svg?md=31b0e449112fcc4e895a653e28dffb22" alt="place-order" />
               </div>
               <div className="text-center">
